    ...
    <div class="card" style="margin-left: 100px; margin-right: 100px; border: none; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);">
        <div class="card-body">
          <div class="table-responsive" style="padding-top: 20px; margin-left: 10px;">
              <h6 style="padding-bottom: 20px; color: #656b71;">Product form</h6>
              @if ($errors->any())
            ...
            @endif
            <form action="{{route('add.product')}}" method="POST" enctype="multipart/form-data" style="margin-left: 80px; margin-right: 80px;" novalidate>
                @csrf
                <div class="row">
