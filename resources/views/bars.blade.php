      ...
      <div class="card-body">
        <div class="table-responsive" style="padding-top: 20px; margin-left: 10px;">
          <div class="btn-group mr-2" style="float: right;">
              <a type="submit" class="btn btn-sm btn-outline-primary" href="{{route('barform')}}">Add new product</a>
              <a type="submit" class="btn btn-sm btn-outline-primary" href="{{route('bexpenses')}}">Expenses</a>
